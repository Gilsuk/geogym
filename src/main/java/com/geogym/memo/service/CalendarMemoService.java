package com.geogym.memo.service;
...
public interface CalendarMemoService {
	 ...
	 */
	CalendarMemo getMemo(User user, LocalDate date) throws MemoNotFoundException;
	 ...
	 * @return ScheduleMemo의 모든 필드를 포함한다.
	 */
	List<CalendarMemo> getMemosList(User user, LocalDate from, LocalDate to);
