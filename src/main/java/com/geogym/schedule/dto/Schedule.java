...
public class Schedule implements DateContent {
	...
	public String toString() {
		return "Schedule [schedule_no=" + schedule_no + ", trainer=" + trainer + ", schedule_date=" + schedule_date
				+ ", schedule_from=" + schedule_from + ", schedule_to=" + schedule_to + ", schedule_msg=" + schedule_msg
				+ ", user_no=" + user_no + "]";
	}
